    ...
    <>
      <div className="">
        <button
          ...
          className="w-full text-3xl  bg-gradient-to-r from-blue-300 to-purple-300 text-white py-3 rounded-xl hover:shadow-lg transform hover:scale-105 transition-transform duration-300 hover:underline"
        >
          জমা দিন
        </button>
      </div>
